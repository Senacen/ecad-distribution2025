...
void Vtb_updowncounter___024root___nba_sequent__TOP__2(Vtb_updowncounter___024root* vlSelf);
void Vtb_updowncounter___024root___nba_sequent__TOP__3(Vtb_updowncounter___024root* vlSelf);
...
void Vtb_updowncounter___024root___eval_nba(Vtb_updowncounter___024root* vlSelf) {
    ...
    if ((4ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        Vtb_updowncounter___024root___nba_sequent__TOP__2(vlSelf);
    }
    if ((1ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        Vtb_updowncounter___024root___nba_sequent__TOP__3(vlSelf);
    }
}
...
VL_INLINE_OPT void Vtb_updowncounter___024root___nba_sequent__TOP__1(Vtb_updowncounter___024root* vlSelf) {
    ...
    vlSelfRef.count = ((IData)(vlSelfRef.rst) ? 0U : 
                       (0xfU & ((IData)(vlSelfRef.tb_updowncounter__DOT__up)
                                 ? ((IData)(1U) + (IData)(vlSelfRef.count))
                                 : ((IData)(vlSelfRef.count) 
                                    - (IData)(1U)))));
}

VL_INLINE_OPT void Vtb_updowncounter___024root___nba_sequent__TOP__2(Vtb_updowncounter___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_updowncounter___024root___nba_sequent__TOP__2\n"); );
    Vtb_updowncounter__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_INLINE_OPT void Vtb_updowncounter___024root___nba_sequent__TOP__3(Vtb_updowncounter___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_updowncounter___024root___nba_sequent__TOP__3\n"); );
    Vtb_updowncounter__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
