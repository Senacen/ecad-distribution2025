...
VL_ATTR_COLD void Vtb_updowncounter___024root___ctor_var_reset(Vtb_updowncounter___024root* vlSelf) {
    ...
    vlSelf->tb_updowncounter__DOT__up = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 16487224038590046909ull);
    vlSelf->__VdlyVal__clk__v0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 626985649275817141ull);
    vlSelf->__VdlySet__clk__v0 = 0;
